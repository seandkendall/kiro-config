...
welcomeMessage: Master orchestrator ready. I route any task to the right specialist subagent, generate images and diagrams, and write deploy.sh scripts. What are we building?
tools:
- read
- write
- shell
